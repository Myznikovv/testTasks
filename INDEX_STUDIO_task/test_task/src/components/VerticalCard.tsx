...
const VerticalCard = ({card}:CardsProps) => {
    ...
    return (
        <Card key={card.id} sx={{m:"15px",position:"relative", width: 224 , height:364 , borderRadius:"12px", filter:" drop-shadow(0px 0px 16px rgba(0, 0, 0, 0.1));"}}>
            ...
            />
            {card.seen?  <Box sx={{position:"absolute", width:"94px", height:"24px", borderRadius:8, left: 65, top: 11,bgcolor:"#ffffff"}}>
                <Typography sx={{fontWeight:"400", fontSize:"12px",lineРeight: 14,textФlign: "center",
